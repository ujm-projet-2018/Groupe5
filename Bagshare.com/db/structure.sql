...
CREATE TABLE IF NOT EXISTS `ebagshare`.`T_USER` (
  ...
  `date_inscri` DATETIME NOT NULL DEFAULT '1995-08-11',
  `nom` VARCHAR(45) NOT NULL,
  `prenom` VARCHAR(45) NOT NULL,
  `mail` VARCHAR(45) NOT NULL,
  `tel` VARCHAR(45) NOT NULL,
  `adresse` VARCHAR(150) NOT NULL DEFAULT '20 rue malescourt 42100',
  `password` VARCHAR(100) NOT NULL,
  `est_confirmee` CHAR(1) NOT NULL DEFAULT 'N',
  `date_modif` DATETIME NULL,
  `ip_adress` VARCHAR(45) NULL,
  `identite` VARCHAR(45) NULL,
...
START TRANSACTION;
USE `ebagshare`;
INSERT INTO `ebagshare`.`T_USER` (`id`, `date_inscri`, `nom`, `prenom`, `mail`, `tel`, `adresse`, `password`, `est_confirmee`, `date_modif`, `ip_adress`, `identite`, `identite_confirme`) VALUES (1, '2018-02-17 15:22:32', 'Trabelsi', 'Ousseama', 'troussemaa@gmail.com', '0711001100', '33 allee chantegrillet 42000', 'oussema', 'O', '2018-02-07 15:22:32', '192.0.0.0.1', 'url vers id', 'N');
INSERT INTO `ebagshare`.`T_USER` (`id`, `date_inscri`, `nom`, `prenom`, `mail`, `tel`, `adresse`, `login`, `password`, `est_confirmee`, `date_modif`, `ip_adress`, `identite`, `identite_confirme`) VALUES (2, '2018-01-15 17:02:32', 'Solo', 'Solo', 'Solo@gmail.com', '17', 'saint etienne', 'solo', 'N', '2018-02-07 08:22:15', '192.1.3.2.5', 'url vers passport', 'N');
