-- supprimer tout les requetes
DROP PROCEDURE offre_dispo_u;
DROP PROCEDURE affichage_profil_utilisateur;
DROP PROCEDURE affichage_offre;
DROP PROCEDURE affichage_commentaire_note;
DROP PROCEDURE filtre_kg;
DROP PROCEDURE filtre_prix;
DROP PROCEDURE filtre_company;
DROP PROCEDURE filtre_userconfirme;
DROP PROCEDURE lister_avis_user;
DROP PROCEDURE calculer_note_generale;
DROP PROCEDURE inserer_t_user_history;
DROP TRIGGER t_user_update_trig;
DROP PROCEDURE inserer_t_offre_history;
DROP TRIGGER t_offre_update_trig;
DROP PROCEDURE inserer_t_avis_history;
DROP TRIGGER t_avis_update_trig;
DROP PROCEDURE inserer_t_precision_history;
DROP TRIGGER t_precision_update_trig;
DROP PROCEDURE inserer_t_reserver_history;
DROP TRIGGER t_reserver_update_trig;
DROP PROCEDURE inserer_t_type_article_history;
DROP TRIGGER t_type_article_update_trig;
DROP PROCEDURE inserer_t_article_history;
DROP TRIGGER t_article_update_trig;


-- ****************************************
-- Auteur : Dan
-- Fonctionnalités : 
--    - afficher_user_byId(user_id VARCHAR(45))....selectionne un user par son id
--
...
CREATE PROCEDURE inserer_t_user_history (id INT, id_user INT, date_inscri DATETIME, nom VARCHAR(45), prenom VARCHAR(45), mail VARCHAR(45), tel VARCHAR(45), adresse VARCHAR(150),  password VARCHAR(45), est_confirmee CHAR(1), date_modif DATETIME, ip_adress VARCHAR(45), identite VARCHAR(45), identite_confirme CHAR(1))
BEGIN
	INSERT INTO T_USER_HISTORY VALUES (id, id_user, date_inscri, nom, prenom, mail, tel, adresse, password, est_confirmee, date_modif, ip_adress, identite, identite_confirme);
END|
...
FOR EACH ROW
BEGIN
	CALL inserer_t_user_history (0, OLD.id, OLD.date_inscri, OLD.nom, OLD.prenom, OLD.mail, OLD.tel, OLD.adresse, OLD.password, OLD.est_confirmee, NEW.date_modif, OLD.ip_adress, OLD.identite, OLD.identite_confirme);
END|
